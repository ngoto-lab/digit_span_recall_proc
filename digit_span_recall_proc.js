...
var instructions = {
    type: 'instructions',
    pages: function(){
      pageOne = "<div style='font-size:20px;'><b>課題の説明</b><br><br>これから、数字を記憶する課題を行っていただきます。<br><br>この課題では、スクリーンに1つずつ表示される数列を覚えてください。<br>数列が最後まで表示されると、数字を入力するパッドがスクリーンに表示されるので、パッドをクリックして正しい順序で数列を入力してください。<br>次の画面で、入力した回答の正誤が表示されます。正解であれば緑色の文字で「<span style='color:rgb(0 220 0)'>正解です</span>」が、誤りであれば赤色の文字で「<span style='color:rgb(240 0 0)'>不正解です</span>」が表示されます。<br><u>例:</u> もし '7 4 5 1'という順序で数字が表示されたら, '7 4 5 1'という順序で回答画面に入力してください。<br><br>課題中はメモなどは取らずに覚えてください。<br>課題のイメージをつかんでいただくために、これから、練習課題をやっていただきます。<br> 'スタート！' のボタンをクリックして練習課題を始めてください。<br><br></div>"
      return [pageOne]
    },
